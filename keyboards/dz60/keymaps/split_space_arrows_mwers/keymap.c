...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_b_4_10(
       ...
       // |---1.25---|---1.25---||---1.25---||--------2.75----------||---1.25---|------2.25--------||--------|--------|--------|--------|--------|
            KC_HYPR,    KC_LALT,    KC_LGUI,         KC_SPC,             MO(3),       MO(1),          TG(2),   TG(3),  KC_LEFT, KC_DOWN, KC_RGHT
       // |----------|----------||----------||----------------------||----------|------------------||--------|--------|--------|--------|--------|
    ),
    ...
    LAYOUT_b_4_10(
       ...
       //
       // |---1.25---|---1.25---||---1.25---||--------2.75----------||---1.25---|------2.25--------||--------|--------|--------|--------|--------|
             XXXXXXX,   XXXXXXX,    XXXXXXX,        XXXXXXX,           _______,        KC_P0,        XXXXXXX,   TG(3), XXXXXXX, XXXXXXX, XXXXXXX
       // |----------|----------||----------||----------------------||----------|------------------||--------|--------|--------|--------|--------|
    ),
